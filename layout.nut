...
class UserConfig {
	...
	</ label="Enabel Frame Around Video", help="Select frame option", options="Yes, No", order=3 /> enable_frame="No";
...
{
local bgart = PanAndScanImage( "../../menu-art/flyer/Project HyperPie.png", 0, 0, flw, flh);
